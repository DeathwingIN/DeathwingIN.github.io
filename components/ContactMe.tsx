...
const ContactMe = () => {
    ...
    return (
        <section className="flex flex-col sm:flex-row justify-center items-center gap-2  relative">
            <div className="flex-3 md:flex-1">
                ...
                >
                    <form onSubmit={handleSubmit} className="relative z-30 p-4 md:p-8 xl:mt-[200px]">
